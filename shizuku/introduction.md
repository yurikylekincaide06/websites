...
The name Shizuku comes from [PACKAGE_MANAGER](https://danbooru.donmai.us/posts/3553474).
...
3. (pre-Pie) Start the Java process with app_process (["package"](https://android.googlesource.com/platform/frameworks/base/+/oreo-release/cmds/pm/pm))
